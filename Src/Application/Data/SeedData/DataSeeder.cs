...
namespace Company.Project.Application.Data.SeedData
{
    public class DataSeeder
    {
        ...
        public async SystemTask SeedAllAsync(CancellationToken cancellationToken)
        {
        ...
        private async SystemTask SeedPersonsAsync(CancellationToken cancellationToken)
        {
            var Persons = new[]
            {
                ...
                new PersonEntity { FirstName = "Anna", LastName = "Brown", Dob = new DateTime(1969,08,13), Address = (Address)"Rua Orós 92, Sao Paulo, Sao Paulo, Brazil, 12345"},
                new PersonEntity { FirstName = "Martín", LastName = "Moreno", Dob = new DateTime(1990,11,30), Address = (Address)"Via Monte Bianco 34, Torino, Toscany, Italy, 98765"},
                new PersonEntity { FirstName = "Pedro", LastName = "Afonso", Dob = new DateTime(1978,04,12), Address = (Address)"Jardim das rosas n. 32, Lisboa, Lisboa, Prtugal, 65412"}
            };
